...
"""
    ...
    Optimization simulator for PSO testing. Second tier OO design to
    be complimented with low level function class and higher tier
    simulation harness.  
 """
...
class Swarm(object):
    ...
    """
     ...
     @param starConfig:     Boolean control for global neighborhood
     @param selflessConfig: Boolean control for non-local best.
     """
